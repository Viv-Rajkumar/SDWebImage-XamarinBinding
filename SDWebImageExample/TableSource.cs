...
namespace SDWebImageExample
{
	public class TableSource : UITableViewSource {
		private TableViewController _viewController;
		private readonly List<NSUrl> _urls = new List<NSUrl>();
		private string _cellIdentifier = "CustomCell";
		public TableSource (TableViewController viewController)
		{
			#region Sample Url's to fetch images
		...
		{
			var cell = tableView.DequeueReusableCell (_cellIdentifier) as CustomCell;
			if (cell == null)
				throw new InvalidCastException();
			cell.SetContent (string.Format ("Row Num: {0}", indexPath.Row + 1));
			cell.SampleImageView.SetImageWithURL (_urls [indexPath.Row], UIImage.FromBundle ("placeholder.png"));
			return cell;
		}

		public override void RowSelected (UITableView tableView, NSIndexPath indexPath)
		{
			_viewController.ShowDetailView (_urls[indexPath.Row]);
		}
	}
}
